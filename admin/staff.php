...
<body>
    <div class="addroomsection">
        <form action="" method="POST">
            <label for="troom">نام :</label>
            <input type="text" name="staffname" class="form-control">

            <label for="bed">وظیفه :</label>
            <select name="staffwork" class="form-control">
                <option value selected></option>
                <option value="مدیر">مدیر</option>
                <option value="آشپز">آشپز</option>
                <option value="دستیار">دستیار</option>
                <option value="نظافت چی">نظافت چی</option>
                <option value="گارسون">گارسون</option>
            </select>

            <button type="submit" class="btn btn-success" name="addstaff">اضافه کردن</button>
        </form>
        ...
        while ($row = mysqli_fetch_array($re)) {
                echo "<div class='roombox'>
						<div class='text-center no-boder'>
                            ...
                            <a href='staffdelete.php?id=". $row['id'] ."'><button class='btn btn-danger'>حذف</button></a>
						</div>
                    </div>";
        }
        ?>
